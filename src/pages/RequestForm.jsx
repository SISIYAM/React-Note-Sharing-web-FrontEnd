...
function RequestForm() {
  ...
  const handleApi = async (body) => {
    try {
      const response = await axios.post(`${baseUrl}/request/material`, body);
  ...
  return (
    <section className="pt-4 pt-sm-5" style={{ marginTop: "130px" }}>
      <div className="container">
        <div className="row g-4 g-md-5 justify-content-between">
          {/* Content START */}
          <div className="col-lg-6 mb-5 mb-lg-0">
            {/* Title */}
            <h1>Request for material</h1>
            <p className="mb-5">
              Let's find out the demo. The 1-hour demo will provide Happiness
              prosperous impression had conviction For every delay in their
            ...
            <ul className="list-group list-group-borderless mt-3 mb-sm-5">
              <li className="list-group-item h6 fw-light d-flex">
                <i className="fas fa-check-circle fa-fw text-success me-2" />
            ...
            <div className="bg-dark rounded-3 p-4 p-sm-5 position-relative">
              ...
              >
                ...
                <div className="col-12 bg-dark-input">
                  <label className="form-label text-white text-opacity-50">
                    Additional note(s) <span className="text-danger">*</span>
                  </label>
                  <textarea
                    name="note"
                    className="form-control"
