  ...
  return (
    <div className="row position-relative mb-0 ">
      <div className="col-lg-8 text-center mx-auto position-relative">
        ...
        {/* Title */}
        <h3>Gallery of Memories </h3>
        <p style={{ textAlign: "justify" }}>
          As part of our journey, we’ve captured many special moments as a
          batch. Below is a gallery of our memories—from classroom sessions to
          group activities, field trips, and more. We cherish these memories and
          share them with you as a part of our story.
        </p>
      </div>
    </div>
  );
