    ...
    <div className="row position-relative mb-0 ">
      <div className="col-lg-8 text-center mx-auto position-relative">
              ...
              <div className="col-md-8 text-center mx-auto">
                <div className="card card-body shadow p-2">
                  <div className="position-relative">
                    {/* Image */}
                    <img
                      src="/assets/images/memories/siyam-profile.jpg"
        ...
        <p style={{ textAlign: "justify" }}>
          SEI Notes was proudly developed by Md Saymum Islam Siyam, a student
          from AE (Avionics) 3rd Batch, BSMRAAU. Siyam is the Founder & CTO of
          SEI Innovations, a company committed to creating technological
          solutions that enhance education and innovation. <br />
          The platform is distributed and maintained by SEI Innovations and is
          continuously improved to offer students the best possible experience.
        </p>

        <h3>Special Thanks to SEI Innovations</h3>

        <p style={{ textAlign: "justify" }}>
          A special thanks to SEI Innovations for bearing the hosting and domain
          costs for SEI Notes. Their support has been instrumental in bringing
          this platform to life and ensuring it remains a valuable resource for
          students.
        </p>
      </div>
    </div>
