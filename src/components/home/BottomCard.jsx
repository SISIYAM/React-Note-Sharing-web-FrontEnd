                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-lg-7">
                      <h3 className="text-white mb-0">
                        Enhance Your Learning at BAAU
                      </h3>
                      <p className="text-white small">
                        Join now to start accessing assessments and study guides
                        from BAAU’s vast library. Free registration with
                        powerful features for all students!
                      </p>
                      {/* List */}
